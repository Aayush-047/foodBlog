...
//   try {
//     await Recipe.deleteMany({ name: 'Masala dosa' });
//   } catch (error) {
//     console.log(error);
//   }
// }
...
//   try {
//     const res = await Recipe.updateOne({ name: 'Crab cakes' }, { description: 'Preheat the oven to 175ºC/gas. Lightly grease a 22cm metal or glass pie dish with a little of the butter.For the pie crust, blend the biscuits, sugar and remaining butter in a food processor until the mixture resembles breadcrumbs.Transfer to the pie dish and spread over the bottom and up the sides, firmly pressing down.Bake for 10 minutes, or until lightly browned. Remove from oven and place the dish on a wire rack to cool.For the filling, whisk the egg yolks in a bowl. Gradually whisk in the condensed milk until smooth.Mix in 6 tablespoons of lime juice, then pour the filling into the pie crust and level over with the back of a spoon.Return to the oven for 15 minutes, then place on a wire rack to cool.Once cooled, refrigerate for 6 hours or overnight.To serve, whip the cream until it just holds stiff peaks. Add dollops of cream to the top of the pie, and grate over some lime zest, for extra zing if you like.' });
